...
hl('fugitiveUntrackedHeading', { fg = colors.warning, bold = true })
hl('fugitiveUnstagedHeading', { fg = colors.vcs_modified, bold = true })
hl('fugitiveStagedHeading', { fg = colors.vcs_added, bold = true })
hl('fugitiveUntrackedModifier', { fg = colors.warning })
hl('fugitiveUnstagedModifier', { fg = colors.vcs_modified })
hl('fugitiveStagedModifier', { fg = colors.vcs_added })
hl('fugitiveUntrackedSection', { fg = colors.warning })
hl('fugitiveUnstagedSection', { fg = colors.vcs_modified })
hl('fugitiveStagedSection', { fg = colors.vcs_added })
hl('fugitiveHash', { fg = colors.constant })
hl('fugitiveSymbolicRef', { fg = colors.tag })
hl('fugitiveCount', { fg = colors.special })
